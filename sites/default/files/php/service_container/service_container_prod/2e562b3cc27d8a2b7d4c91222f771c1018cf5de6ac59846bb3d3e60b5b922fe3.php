...
class service_container_prod extends \Drupal\Core\DependencyInjection\Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'cache_context.menu.active_trail' => 'getCacheContext_Menu_ActiveTrailService',
    ...
    {
        $this->services['accept_header_matcher'] = $instance = new \Drupal\Core\Routing\AcceptHeaderMatcher($this->get('content_negotiation'));
    ...
    {
        $this->services['ajax.subscriber'] = $instance = new \Drupal\Core\Ajax\AjaxSubscriber();

        $instance->_serviceId = 'ajax.subscriber';
    ...
    {
        $this->services['app.root.factory'] = $instance = new \Drupal\Core\AppRootFactory($this->get('kernel'));

        $instance->_serviceId = 'app.root.factory';
    ...
    {
        $this->services['authentication.cookie'] = $instance = new \Drupal\Core\Authentication\Provider\Cookie();

        $instance->_serviceId = 'authentication.cookie';
    ...
    {
        $this->services['authentication_subscriber'] = $instance = new \Drupal\Core\EventSubscriber\AuthenticationSubscriber($this->get('authentication'));
    ...
    {
        $this->services['bare_html_page_renderer'] = $instance = new \Drupal\Core\Render\BareHtmlPageRenderer($this->get('renderer'));
    ...
    {
        $this->services['batch.storage'] = $instance = new \Drupal\Core\Batch\BatchStorage($this->get('database'), $this->get('session'), $this->get('csrf_token'));
    ...
    {
        $this->services['cache_context.language'] = $instance = new \Drupal\Core\Cache\LanguageCacheContext($this->get('language_manager'));

        $instance->_serviceId = 'cache_context.language';

        return $instance;
    }

    /**
     * Gets the 'cache_context.menu.active_trail' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Drupal\Core\Cache\MenuActiveTrailCacheContext A Drupal\Core\Cache\MenuActiveTrailCacheContext instance.
     */
    protected function getCacheContext_Menu_ActiveTrailService()
    {
        $this->services['cache_context.menu.active_trail'] = $instance = new \Drupal\Core\Cache\MenuActiveTrailCacheContext();

        $instance->setContainer($this);
        $instance->_serviceId = 'cache_context.menu.active_trail';
    ...
    {
        $this->services['cache_context.node_view_grants'] = $instance = new \Drupal\node\Cache\NodeAccessViewGrantsCacheContext($this->get('current_user'));

        $instance->_serviceId = 'cache_context.node_view_grants';
    ...
    {
        $this->services['cache_context.user'] = $instance = new \Drupal\user\Cache\UserCacheContext($this->get('current_user'));
    ...
    {
        $this->services['cache_context.user.roles'] = $instance = new \Drupal\user\Cache\UserRolesCacheContext($this->get('current_user'));
    ...
    {
        $this->services['cache_contexts'] = $instance = new \Drupal\Core\Cache\CacheContexts($this, array(0 => 'url', 1 => 'language', 2 => 'theme', 3 => 'timezone', 4 => 'menu.active_trail', 5 => 'node_view_grants', 6 => 'user', 7 => 'user.roles'));

        $instance->_serviceId = 'cache_contexts';
    ...
    {
        $this->services['config.installer'] = $instance = new \Drupal\Core\Config\ConfigInstaller($this->get('config.factory'), $this->get('config.storage'), $this->get('config.typed'), $this->get('config.manager'), $this->get('event_dispatcher'));
    ...
    {
        $this->services['config.storage.installer'] = $instance = new \Drupal\Core\Config\InstallStorage();

        $instance->_serviceId = 'config.storage.installer';
    ...
    {
        $this->services['container.namespaces'] = $instance = new \ArrayObject(array('Drupal\\block' => '/var/www/drupal8/core/modules/block/src', 'Drupal\\block_content' => '/var/www/drupal8/core/modules/block_content/src', 'Drupal\\breakpoint' => '/var/www/drupal8/core/modules/breakpoint/src', 'Drupal\\ckeditor' => '/var/www/drupal8/core/modules/ckeditor/src', 'Drupal\\color' => '/var/www/drupal8/core/modules/color/src', 'Drupal\\comment' => '/var/www/drupal8/core/modules/comment/src', 'Drupal\\config' => '/var/www/drupal8/core/modules/config/src', 'Drupal\\contact' => '/var/www/drupal8/core/modules/contact/src', 'Drupal\\contextual' => '/var/www/drupal8/core/modules/contextual/src', 'Drupal\\datetime' => '/var/www/drupal8/core/modules/datetime/src', 'Drupal\\dblog' => '/var/www/drupal8/core/modules/dblog/src', 'Drupal\\editor' => '/var/www/drupal8/core/modules/editor/src', 'Drupal\\entity_reference' => '/var/www/drupal8/core/modules/entity_reference/src', 'Drupal\\field' => '/var/www/drupal8/core/modules/field/src', 'Drupal\\field_ui' => '/var/www/drupal8/core/modules/field_ui/src', 'Drupal\\file' => '/var/www/drupal8/core/modules/file/src', 'Drupal\\filter' => '/var/www/drupal8/core/modules/filter/src', 'Drupal\\help' => '/var/www/drupal8/core/modules/help/src', 'Drupal\\history' => '/var/www/drupal8/core/modules/history/src', 'Drupal\\image' => '/var/www/drupal8/core/modules/image/src', 'Drupal\\link' => '/var/www/drupal8/core/modules/link/src', 'Drupal\\menu_ui' => '/var/www/drupal8/core/modules/menu_ui/src', 'Drupal\\node' => '/var/www/drupal8/core/modules/node/src', 'Drupal\\options' => '/var/www/drupal8/core/modules/options/src', 'Drupal\\path' => '/var/www/drupal8/core/modules/path/src', 'Drupal\\quickedit' => '/var/www/drupal8/core/modules/quickedit/src', 'Drupal\\rdf' => '/var/www/drupal8/core/modules/rdf/src', 'Drupal\\scotts_module' => '/var/www/drupal8/modules/scotts_module/src', 'Drupal\\search' => '/var/www/drupal8/core/modules/search/src', 'Drupal\\shortcut' => '/var/www/drupal8/core/modules/shortcut/src', 'Drupal\\system' => '/var/www/drupal8/core/modules/system/src', 'Drupal\\taxonomy' => '/var/www/drupal8/core/modules/taxonomy/src', 'Drupal\\text' => '/var/www/drupal8/core/modules/text/src', 'Drupal\\toolbar' => '/var/www/drupal8/core/modules/toolbar/src', 'Drupal\\tour' => '/var/www/drupal8/core/modules/tour/src', 'Drupal\\update' => '/var/www/drupal8/core/modules/update/src', 'Drupal\\user' => '/var/www/drupal8/core/modules/user/src', 'Drupal\\views_ui' => '/var/www/drupal8/core/modules/views_ui/src', 'Drupal\\menu_link_content' => '/var/www/drupal8/core/modules/menu_link_content/src', 'Drupal\\views' => '/var/www/drupal8/core/modules/views/src', 'Drupal\\standard' => '/var/www/drupal8/core/profiles/standard/src', 'Drupal\\Core\\Entity' => '/var/www/drupal8/core/lib/Drupal/Core/Entity', 'Drupal\\Core\\Render' => '/var/www/drupal8/core/lib/Drupal/Core/Render', 'Drupal\\Core\\Config' => '/var/www/drupal8/core/lib/Drupal/Core/Config', 'Drupal\\Core\\Datetime' => '/var/www/drupal8/core/lib/Drupal/Core/Datetime', 'Drupal\\Core\\TypedData' => '/var/www/drupal8/core/lib/Drupal/Core/TypedData', 'Drupal\\Core\\Field' => '/var/www/drupal8/core/lib/Drupal/Core/Field', 'Drupal\\Core\\Mail' => '/var/www/drupal8/core/lib/Drupal/Core/Mail', 'Drupal\\Core\\Validation' => '/var/www/drupal8/core/lib/Drupal/Core/Validation', 'Drupal\\Core\\Block' => '/var/www/drupal8/core/lib/Drupal/Core/Block', 'Drupal\\Component\\Annotation' => '/var/www/drupal8/core/lib/Drupal/Component/Annotation'));
    ...
    {
        $this->services['content_negotiation'] = $instance = new \Drupal\Core\ContentNegotiation();

        $instance->_serviceId = 'content_negotiation';
    ...
    {
        $this->services['content_uninstall_validator'] = $instance = new \Drupal\Core\Entity\ContentUninstallValidator($this->get('entity.manager'), $this->get('string_translation'));
    ...
    {
        $this->services['current_user'] = $instance = new \Drupal\Core\Session\AccountProxy($this->get('authentication'), $this->get('request_stack'));
    ...
    {
        $this->services['exception.custom_page_html'] = $instance = new \Drupal\Core\EventSubscriber\CustomPageExceptionHtmlSubscriber($this->get('config.factory'), $this->get('path.alias_manager'), $this->get('http_kernel'), $this->get('logger.channel.php'));
    ...
    {
        $this->services['exception.default_html'] = $instance = new \Drupal\Core\EventSubscriber\DefaultExceptionHtmlSubscriber($this->get('http_kernel'), $this->get('logger.channel.php'));
    ...
    {
        $this->services['field_uninstall_validator'] = $instance = new \Drupal\Core\Field\FieldModuleUninstallValidator($this->get('entity.manager'), $this->get('string_translation'));
    ...
    {
        $this->services['file.mime_type.guesser.extension'] = $instance = new \Drupal\Core\File\MimeType\ExtensionMimeTypeGuesser($this->get('module_handler'));
    ...
    {
        $this->services['finish_response_subscriber'] = $instance = new \Drupal\Core\EventSubscriber\FinishResponseSubscriber($this->get('language_manager'), $this->get('config.factory'), $this->get('page_cache_request_policy'), $this->get('page_cache_response_policy'));
    ...
    protected function getHttpKernelService()
    {
        ...
        $this->services['http_kernel'] = $instance = new \Stack\StackedHttpKernel($a, array(0 => $a, 1 => $this->get('http_middleware.page_cache'), 2 => $this->get('http_middleware.kernel_pre_handle'), 3 => $this->get('http_middleware.session'), 4 => $this->get('http_kernel.basic')));
    ...
    {
        $this->services['http_middleware.page_cache'] = $instance = new \Drupal\Core\StackMiddleware\PageCache($this->get('http_middleware.kernel_pre_handle'), $this->get('cache.render'), $this->get('page_cache_request_policy'), $this->get('page_cache_response_policy'), $this->get('content_negotiation'));
    ...
    {
        $this->services['image.page_cache_request_policy.deny_private_image_style_download'] = $instance = new \Drupal\image\PageCache\DenyPrivateImageStyleDownload($this->get('current_route_match'));

        $instance->_serviceId = 'image.page_cache_request_policy.deny_private_image_style_download';
    ...
    {
        $this->services['library.discovery'] = $instance = new \Drupal\Core\Asset\LibraryDiscovery($this->get('library.discovery.collector'), $this->get('module_handler'));
    ...
    {
        $this->services['library.discovery.collector'] = $instance = new \Drupal\Core\Asset\LibraryDiscoveryCollector($this->get('cache.discovery'), $this->get('lock'), $this->get('library.discovery.parser'));
    ...
    {
        $this->services['library.discovery.parser'] = $instance = new \Drupal\Core\Asset\LibraryDiscoveryParser($this->get('app.root'), $this->get('module_handler'));
    ...
    {
        $this->services['lock'] = $instance = new \Drupal\Core\Lock\DatabaseLockBackend($this->get('database'));
    ...
    {
        $this->services['lock.persistent'] = $instance = new \Drupal\Core\Lock\PersistentDatabaseLockBackend($this->get('database'));
    ...
    {
        $this->services['main_content_renderer.html'] = $instance = new \Drupal\Core\Render\MainContent\HtmlRenderer($this->get('title_resolver'), $this->get('plugin.manager.display_variant'), $this->get('event_dispatcher'), $this->get('module_handler'), $this->get('renderer'));
    ...
    {
        $this->services['node.page_cache_request_policy.deny_node_preview'] = $instance = new \Drupal\node\PageCache\DenyNodePreview($this->get('current_route_match'));

        $instance->_serviceId = 'node.page_cache_request_policy.deny_node_preview';
    ...
    {
        $this->services['paramconverter.configentity_admin'] = $instance = new \Drupal\Core\ParamConverter\AdminPathConfigEntityConverter($this->get('entity.manager'), $this->get('config.factory'), $this->get('router.admin_context'));
    ...
    {
        $this->services['paramconverter.menu_link'] = $instance = new \Drupal\Core\ParamConverter\MenuLinkPluginConverter($this->get('plugin.manager.menu.link'));
    ...
    {
        $this->services['paramconverter.views_ui'] = $instance = new \Drupal\views_ui\ParamConverter\ViewUIConverter($this->get('entity.manager'), $this->get('user.shared_tempstore'));
    ...
    {
        $this->services['plugin.manager.element_info'] = $instance = new \Drupal\Core\Render\ElementInfoManager($this->get('container.namespaces'), $this->get('cache.discovery'), $this->get('module_handler'));
    ...
    {
        $this->services['plugin.manager.field.field_type'] = $instance = new \Drupal\Core\Field\FieldTypePluginManager($this->get('container.namespaces'), $this->get('cache.discovery'), $this->get('module_handler'));
    ...
    {
        $this->services['renderer'] = $instance = new \Drupal\Core\Render\Renderer($this->get('controller_resolver'), $this->get('theme.manager'), $this->get('plugin.manager.element_info'), $this->get('request_stack'), $this->get('cache_factory'), $this->get('cache_contexts'));
    ...
    {
        $this->services['route_content_controller_subscriber'] = $instance = new \Drupal\Core\EventSubscriber\ContentControllerSubscriber($this->get('content_negotiation'));
    ...
    {
        $this->services['route_enhancer.authentication'] = $instance = new \Drupal\Core\Routing\Enhancer\AuthenticationEnhancer($this->get('authentication'), $this->get('current_user'));

        $instance->_serviceId = 'route_enhancer.authentication';
    ...
    {
        $this->services['route_enhancer.lazy_collector'] = $instance = new \Drupal\Core\Routing\LazyRouteEnhancer(array('route_enhancer.param_conversion' => 'route_enhancer.param_conversion', 'route_enhancer.authentication' => 'route_enhancer.authentication', 'route_enhancer.entity' => 'route_enhancer.entity'));
    ...
    {
        $this->services['router.builder'] = $instance = new \Drupal\Core\Routing\RouteBuilder($this->get('router.dumper'), $this->get('lock'), $this->get('event_dispatcher'), $this->get('module_handler'), $this->get('controller_resolver'), $this->get('access_manager.check_provider'), $this->get('router.builder_indicator'));
    ...
    {
        $this->services['router.builder_indicator'] = $instance = new \Drupal\Core\Routing\RouteBuilderIndicator($this->get('state'));

        $instance->_serviceId = 'router.builder_indicator';
    ...
    {
        $this->services['router.dumper'] = $instance = new \Drupal\Core\Routing\MatcherDumper($this->get('database'), $this->get('state'));
    ...
    {
        $this->services['router.rebuild_subscriber'] = $instance = new \Drupal\Core\EventSubscriber\RouterRebuildSubscriber($this->get('router.builder'));

        $instance->_serviceId = 'router.rebuild_subscriber';
    ...
    {
        $this->services['router.route_preloader'] = $instance = new \Drupal\Core\Routing\RoutePreloader($this->get('router.route_provider'), $this->get('state'), $this->get('content_negotiation'));
    ...
    {
        $this->services['router.route_provider'] = $instance = new \Drupal\Core\Routing\RouteProvider($this->get('database'), $this->get('router.builder'), $this->get('state'), $this->get('path.current'));
    ...
    {
        $this->services['theme.initialization'] = $instance = new \Drupal\Core\Theme\ThemeInitialization($this->get('app.root'), $this->get('theme_handler'), $this->get('state'));
    ...
    {
        $this->services['theme.manager'] = $instance = new \Drupal\Core\Theme\ThemeManager($this->get('app.root'), $this->get('theme.registry'), $this->get('theme.negotiator'), $this->get('theme.initialization'), $this->get('request_stack'), $this->get('module_handler'));
    ...
    {
        $this->services['twig.loader.string'] = $instance = new \Twig_Loader_String();
    ...
    {
        $this->services['update.manager'] = $instance = new \Drupal\update\UpdateManager($this->get('config.factory'), $this->get('module_handler'), $this->get('update.processor'), $this->get('string_translation'), $this->get('keyvalue.expirable'));
    ...
    {
        $this->services['user.autocomplete'] = $instance = new \Drupal\user\UserAutocomplete($this->get('config.factory'), $this->get('entity.manager'), $this->get('entity.query'));

        $instance->_serviceId = 'user.autocomplete';
    ...
    {
        $this->services['user.permissions_hash'] = $instance = new \Drupal\user\PermissionsHash($this->get('private_key'), $this->get('cache.default'));

        $instance->_serviceId = 'user.permissions_hash';
    ...
    {
        $this->services['user.shared_tempstore'] = $instance = new \Drupal\user\SharedTempStoreFactory($this->get('keyvalue.expirable'), $this->get('lock'), 604800);
    ...
    {
        $this->services['view_subscriber'] = $instance = new \Drupal\Core\EventSubscriber\ViewSubscriber($this->get('content_negotiation'), $this->get('title_resolver'));
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'container.modules' => array(
                ...
                'scotts_module' => array(
                    'type' => 'module',
                    'pathname' => 'modules/scotts_module/scotts_module.info.yml',
                    'filename' => 'scotts_module.module',
                ),
                'search' => array(
                    'type' => 'module',
            ...
            'container.namespaces' => array(
                'Drupal\\block' => '/var/www/drupal8/core/modules/block/src',
                'Drupal\\block_content' => '/var/www/drupal8/core/modules/block_content/src',
                'Drupal\\breakpoint' => '/var/www/drupal8/core/modules/breakpoint/src',
                'Drupal\\ckeditor' => '/var/www/drupal8/core/modules/ckeditor/src',
                'Drupal\\color' => '/var/www/drupal8/core/modules/color/src',
                'Drupal\\comment' => '/var/www/drupal8/core/modules/comment/src',
                'Drupal\\config' => '/var/www/drupal8/core/modules/config/src',
                'Drupal\\contact' => '/var/www/drupal8/core/modules/contact/src',
                'Drupal\\contextual' => '/var/www/drupal8/core/modules/contextual/src',
                'Drupal\\datetime' => '/var/www/drupal8/core/modules/datetime/src',
                'Drupal\\dblog' => '/var/www/drupal8/core/modules/dblog/src',
                'Drupal\\editor' => '/var/www/drupal8/core/modules/editor/src',
                'Drupal\\entity_reference' => '/var/www/drupal8/core/modules/entity_reference/src',
                'Drupal\\field' => '/var/www/drupal8/core/modules/field/src',
                'Drupal\\field_ui' => '/var/www/drupal8/core/modules/field_ui/src',
                'Drupal\\file' => '/var/www/drupal8/core/modules/file/src',
                'Drupal\\filter' => '/var/www/drupal8/core/modules/filter/src',
                'Drupal\\help' => '/var/www/drupal8/core/modules/help/src',
                'Drupal\\history' => '/var/www/drupal8/core/modules/history/src',
                'Drupal\\image' => '/var/www/drupal8/core/modules/image/src',
                'Drupal\\link' => '/var/www/drupal8/core/modules/link/src',
                'Drupal\\menu_ui' => '/var/www/drupal8/core/modules/menu_ui/src',
                'Drupal\\node' => '/var/www/drupal8/core/modules/node/src',
                'Drupal\\options' => '/var/www/drupal8/core/modules/options/src',
                'Drupal\\path' => '/var/www/drupal8/core/modules/path/src',
                'Drupal\\quickedit' => '/var/www/drupal8/core/modules/quickedit/src',
                'Drupal\\rdf' => '/var/www/drupal8/core/modules/rdf/src',
                'Drupal\\scotts_module' => '/var/www/drupal8/modules/scotts_module/src',
                'Drupal\\search' => '/var/www/drupal8/core/modules/search/src',
                'Drupal\\shortcut' => '/var/www/drupal8/core/modules/shortcut/src',
                'Drupal\\system' => '/var/www/drupal8/core/modules/system/src',
                'Drupal\\taxonomy' => '/var/www/drupal8/core/modules/taxonomy/src',
                'Drupal\\text' => '/var/www/drupal8/core/modules/text/src',
                'Drupal\\toolbar' => '/var/www/drupal8/core/modules/toolbar/src',
                'Drupal\\tour' => '/var/www/drupal8/core/modules/tour/src',
                'Drupal\\update' => '/var/www/drupal8/core/modules/update/src',
                'Drupal\\user' => '/var/www/drupal8/core/modules/user/src',
                'Drupal\\views_ui' => '/var/www/drupal8/core/modules/views_ui/src',
                'Drupal\\menu_link_content' => '/var/www/drupal8/core/modules/menu_link_content/src',
                'Drupal\\views' => '/var/www/drupal8/core/modules/views/src',
                'Drupal\\standard' => '/var/www/drupal8/core/profiles/standard/src',
                'Drupal\\Core\\Entity' => '/var/www/drupal8/core/lib/Drupal/Core/Entity',
                'Drupal\\Core\\Render' => '/var/www/drupal8/core/lib/Drupal/Core/Render',
                'Drupal\\Core\\Config' => '/var/www/drupal8/core/lib/Drupal/Core/Config',
                'Drupal\\Core\\Datetime' => '/var/www/drupal8/core/lib/Drupal/Core/Datetime',
                'Drupal\\Core\\TypedData' => '/var/www/drupal8/core/lib/Drupal/Core/TypedData',
                'Drupal\\Core\\Field' => '/var/www/drupal8/core/lib/Drupal/Core/Field',
                'Drupal\\Core\\Mail' => '/var/www/drupal8/core/lib/Drupal/Core/Mail',
                'Drupal\\Core\\Validation' => '/var/www/drupal8/core/lib/Drupal/Core/Validation',
                'Drupal\\Core\\Block' => '/var/www/drupal8/core/lib/Drupal/Core/Block',
                'Drupal\\Component\\Annotation' => '/var/www/drupal8/core/lib/Drupal/Component/Annotation',
            ),
